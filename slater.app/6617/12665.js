...
! function(D, u) {
    ...
    function getText(D) {
        var u = D.nodeType,
            F = "";
        if (1 === u || 9 === u || 11 === u) {
            if ("string" == typeof D.textContent) return D
                .textContent;
            for (D = D.firstChild; D; D = D.nextSibling) F += getText(D)
        } else if (
            3 === u || 4 === u) return D.nodeValue;
        return F
    }

    function emojiSafeSplit(D, u, F, C) {
        if (D += "", F && (D = D.trim ? D.trim() : D.replace(r,
    ...
    function i() {
        return u || "undefined" != typeof window && (u = window.gsap) && u
            .registerPlugin && u
    }
    ...
    var u, o, B = /\s+/g,
        F = function _scrambleText(D, u) {
            for (var F = u.length, C = ""; - 1 < --D;) C += u[~~(Math
                .random() * F)];
            return C
        },
        ...
        e = {
            ...
            init: function init(D, u, F) {
                if (o || p(), this.prop = "innerHTML" in D ? "innerHTML" :
                    "textContent" in D ? "textContent" : 0, this.prop) {
                    this.target = D, "object" !=
                        typeof u && (u = {
                            text: u
                        });
                    ...
                    return r.delimiter = C = u.delimiter || "", r.original = emojiSafeSplit(
                        ...
                        ._props.push("scrambleText", "text"), 1
                }
            },
    ...
    e.emojiSafeSplit = emojiSafeSplit, e.getText = getText, i() && u.registerPlugin(e), D
        .ScrambleTextPlugin = e, D.default = e;
