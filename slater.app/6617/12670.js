// This file was generated by Slater.app - flickity-transformer.pkgd.min.js
...
var FlickityTransformer = function() {
    ...
    var index = createCommonjsModule(function(module) {
        ...
        function scale(value) {
            ...
            while (i < domains.length - 1) {
                if (value >= domains[i] && value <= domains[i +
                        1]) {
                    domain = [domains[i], domains[i + 1]], range = [ranges[i], ranges[i +
                        1]];
                    break
                }
                i++
    ...
    var
        asyncGenerator = function() {
            ...
            if (
                ...
                AsyncGenerator.prototype[Symbol
            ...
            return {
                wrap: function(fn) {
                    return function() {
                        return new AsyncGenerator(fn
                            .apply(this, arguments))
                    }
                },
                await: function(value) {
                    return new AwaitValue(
                        value)
                }
            }
        }();
    ...
    var createClass = function() {
        ...
        return function(
            ...
            if (protoProps) defineProperties(Constructor
            ...
            createClass(FlickityTransformer, [{
                    ...
                    value: function init() {
                        ...
                        this.flickity.on("scroll", function() {
                            _this.flickity.slides.forEach(_this
                                .applyTransforms.bind(_this))
                        });
                        if (this.flickity._events.scroll ===
                            undefined) {
                            throw new Error(name +
                                " requires the first parameter to be a instance of Flickity that supports the `scroll` event (version 2+)"
                            )
                        }
                        window.addEventListener("resize", function() {
                            _this.flickity.slides
                                .forEach(_this.applyTransforms.bind(_this))
                        })
                    }
                },
                {
                        ...
                        this
                            .transforms.forEach(function(transform) {
                                ...
                                transform.scale = function(value) {
                                    return index(domain, range, true)(
                                        value)
                                }
                            })
                    }
                    ...
                    value: function applyTransforms(slide, i) {
                        ...
                        var txs = [];
                        var xPos = void 0;
                        xPos = slide.parent.x < 0 ? slide.target - Math.abs(slide.parent.x) : slide
                            .target + slide.parent.x;
                        this.transforms.forEach(function(transform) {
                            txs.push(_this2.makeTransform(
                                transform, xPos))
                        });
                    ...
                    value: function makeTransform(transform, xPos) {
                        ...
                        var
                            unit = transform.unit || units[name] || "";
                        var tx = transform.scale(
                            xPos);
                        return name + "(" + tx + unit + ")"
                    }
                }
